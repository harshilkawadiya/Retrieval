...
// All Pascal with synonym
public class NLG_AllPascal_s {
	...
	public static void main (String[] args) throws SQLException
	{
	     ...
	     File dir = new File("/home/user/NLG-Images/Results/AllPascal/s/out1");
	     ...
	     for (int i =0; i<files.length; i++)
	     {
	    	 ...
	    	 try
	    	 {
	    		  FileInputStream fstream = new FileInputStream("/home/user/NLG-Images/Results/AllPascal/s/out1/" + files[i]);
	    		  DataInputStream in = new DataInputStream(fstream);
	    		  BufferedReader br = new BufferedReader(new InputStreamReader(in));
	    		  
	    		  FileWriter fstream_out = new FileWriter("/home/user/NLG-Images/Results/AllPascal/s/NLG-out1/" + files[i]);
