...
// All IAPR without synonym
public class NLG_Iapr_ns {
	...
	public static void main (String[] args) throws SQLException
	{
	     ...
	     File dir = new File("/home/user/NLG-Images/Results/Iapr/ns/out1");
		 ...
		 try
		 {
			 FileWriter fstream_out_aggregation = new FileWriter("/home/user/NLG-Images/Results/Iapr/ns/Aggregation-possible/agg.txt");
	     ...
	     for (int i =0; i<files.length; i++)
	     {
	    	 try
	    	 {
	    		  FileInputStream fstream = new FileInputStream("/home/user/NLG-Images/Results/Iapr/ns/out1/" + files[i]);
	    		  DataInputStream in = new DataInputStream(fstream);
	    		  BufferedReader br = new BufferedReader(new InputStreamReader(in));
	    		  
	    		  FileWriter fstream_out = new FileWriter("/home/user/NLG-Images/Results/Iapr/ns/NLG-out1/" + files[i]);
	    		  ...
	    		  while ((strLine = br.readLine()) != null)
	    		  {
	    			  ...
	    			  if (subject_grouping!=0 || predicate_grouping!=0)
	    			  {
	    				  ...
	    				  {
	    					  // Generate sentence for first triple
	    					  if (verbs_passive_list.contains(verb))
	    	    			  {
	    	    				  sps = nlgFactory.createClause();
