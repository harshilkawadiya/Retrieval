...
files = os.listdir("/home/user/NLG-Images/Rouge-Eval/systems-our-all-pascal-synonym-results");

out_file = open("/home/user/NLG-Images/Rouge-Eval/settings-our-all-pascal-synonym-results.xml","w");
...
for each_file in files:
	...
	out_file.write("  /home/user/NLG-Images/Rouge-Eval/systems-our-all-pascal-synonym-results" + '\n');
	out_file.write("  </PEER-ROOT>" + '\n');
