...
########################### Process for ALl Pascal Non Synonym ################################################
files = os.listdir("/home/user/NLG-Images/Bleu-all-pascal-non-synonym-our-results");
...
for each_file in files:	
	...
	file = open("/home/user/NLG-Images/Bleu-all-pascal-non-synonym-our-results/" + each_file, "r");
...
print "BLEU All Pascal Non Synonym OUR RESULTS";
...
print "Average Smoothed Bleu Score for our all pascal non synonym : " + str(avg_bleu_score);
print "Average Smoothed Individual 1-gram Bleu Score for our all pascal non synonym : " + str(avg_bleu_individual_1_gram_score);
print "Average Smoothed Cumulative 1-gram Bleu Score for our all pascal non synonym : " + str(avg_bleu_cumulative_1_gram_score);

print "Average Smoothed Individual 2-gram Bleu Score for our all pascal non synonym : " + str(avg_bleu_individual_2_gram_score);
print "Average Smoothed Cumulative 2-gram Bleu Score for our all pascal non synonym : " + str(avg_bleu_cumulative_2_gram_score);

print "Average Smoothed Individual 3-gram Bleu Score for our all pascal non synonym : " + str(avg_bleu_individual_3_gram_score);
print "Average Smoothed Cumulative 3-gram Bleu Score for our all pascal non synonym : " + str(avg_bleu_cumulative_3_gram_score);
...
print "Average Nist Score for our all pascal non synonym : " + str(avg_nist_score);
print;
